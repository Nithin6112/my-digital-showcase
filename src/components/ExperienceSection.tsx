import { Briefcase, Award, ExternalLink, FileText, Lightbulb, Building2 } from 'lucide-react';
  ...
  return <section id="about" className="py-20">
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16">
         <h2 className="text-4xl md:text-5xl font-bold mb-4 lg:text-5xl">
            <span className="text-primary">About</span>
          </h2>
          <p className="text-lg lg:text-xl max-w-4xl mx-auto mt-6 text-cyan-50 text-justify">
        ...
        <div className="space-y-8 max-w-5xl mx-auto border-cyan-200">
          ...
          <div className="experience-card bg-card border-cyan-200">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h3 className="text-xl font-bold lg:text-3xl text-primary">Internship</h3>
            </div>
          ...
          <div className="experience-card bg-card border-cyan-200">
            <div className="flex items-center justify-center gap-3 mb-6">
              ...
              <h3 className="text-xl font-bold lg:text-3xl text-primary">Certifications</h3>
            </div>
