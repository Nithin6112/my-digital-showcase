...
const HeroSection = () => {
  ...
  const socialLinks = [
    ...
    { icon: Phone, href: 'tel:+919538186124', label: 'Phone' },
  ];
      ...
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative animate-float">
              ...
              <div className="absolute inset-0 w-[350px] h-[450px] md:w-[400px] md:h-[500px]">
                <svg viewBox="0 0 400 500" className="w-full h-full">
                  ...
                  <path
                    d="M200,50 C320,50 370,150 370,250 C370,380 300,450 200,450 C100,450 30,380 30,250 C30,150 80,50 200,50"
                    fill="hsl(190, 100%, 50%)"
              ...
              <div className="relative w-[350px] h-[450px] md:w-[400px] md:h-[500px] overflow-hidden">
                <svg viewBox="0 0 400 500" className="absolute inset-0 w-full h-full z-10">
                  ...
                  <path
                    d="M180,35 C325,35 365,140 365,250 C365,395 295,465 180,465 C75,465 35,380 35,250 C35,140 65,35 180,35"
                    fill="none"
          ...
          <div className="order-2 lg:order-2 text-center lg:text-left">
            ...
            <p className="text-muted-foreground text-lg mb-8 max-w-xl mx-auto lg:mx-0 italic">
