      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {educationData.map((edu, index) => <div key={index} className="education-card group border-cyan-200">
              ...
              {/* Know More Button */}
              <a href={edu.driveLink} target="_blank" rel="noopener noreferrer" className="know-more-btn text-base rounded-sm text-primary-foreground bg-cyan-600 text-center">
                Know More
