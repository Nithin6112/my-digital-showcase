...
const ContactSection = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const mailtoLink = `mailto:s.nithin6112@gmail.com?subject=${encodeURIComponent(
      formData.subject
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              className="btn-hero-primary flex items-center gap-2 w-full sm:w-auto justify-center"
            >
              Send Message
